    ...
    <div className="w-full">
      ...
      <div className="content h-auto pt-[15px] pb-0 px-[70px]">
        <div className="box1 sm:flex sm:flex-row sm:justify-between mb-[70px] flex flex-col">
          <div className="information sm:w-[1000px] text-[16px] bg-[gainsboro] border min-h-[200px] m-[15px] p-[30px] rounded-[50px] border-solid border-[gray]">
          ...
          <div className="style sm:w-[400px] bg-[gainsboro] border min-h-[200px] m-[15px] p-[30px] rounded-[50px] border-solid border-[gray]">
        ...
        <div className="values">
          ...
          <div className="value-contents sm:flex  sm:justify-around sm:flex-row flex-col  flex items-center">
            ...
            <div className="value-items bg-[#E46000B2] w-[200px] h-[200px] inline-block relative rounded-[50%] sm:mx-[20px] sm:my-[0] my-[20px]">
              <div className="value-text absolute w-full -translate-y-2/4 text-center text-[22px] font-medium top-2/4">
                KHÁCH HÀNG
              </div>
            </div>
