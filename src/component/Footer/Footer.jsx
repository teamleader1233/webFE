...
const Footer = () => {
  return (
    <div className="w-full flex justify-center relative h-[600px]">
      <img
        src={logoFooter}
        alt="imgFooter"
        className="w-screen brightness-50 object-cover"
      />
      <div className="w-4/5 absolute flex justify-between items-center h-full flex-wrap">
        <img src={logoName} alt="logo" className="  w-[30%]" />
        <div className="w-[30%] mx-[20px] px-[20px] py-[40px] b border-x-[2px] font-medium border-[white] border-solid  flex flex-col justify-between text-white">
