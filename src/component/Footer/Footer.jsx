  ...
  return (
    <div className="w-full flex justify-center relative h-[600px]">
      ...
      <div className="w-4/5 absolute flex justify-between items-center h-full">
        <img src={logoName} alt="logo" className="h-[300px]" />
        <div className="mx-[20px] px-[20px] py-[40px] b border-x-[2px] font-medium border-[white] border-solid h-[300px] flex flex-col justify-between text-white">
          ...
          <p className="text-[18px]">Email: svn.logistics99@gmail.com</p>
        </div>
        <a
